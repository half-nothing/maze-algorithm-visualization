...
namespace QT {
    ConfigWidget::ConfigWidget(QWidget *parent) :
        ...
        ui->searchingPointColorWidget->setConfigField(SEARCHING_POINT_COLOR);
        ...
        connect(ui->resetColorSettingButton, &QPushButton::clicked, [this] {
            ...
            ui->searchedPointColorWidget->setColor({112, 188, 255});
            ui->searchingPointColorWidget->setColor({0, 0, 255});
